            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-5">
              ...
              <div className="flex flex-col gap-2.5 shrink-0">
                <Link
                  ...
                  className="flex items-center gap-3 px-5 py-2.5 rounded-xl bg-[#229ED9] text-white text-sm font-bold transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] no-underline"
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 px-5 py-2.5 rounded-xl bg-[#7B44CF] text-white text-sm font-bold transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] no-underline"
