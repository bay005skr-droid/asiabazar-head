        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center py-16 md:py-20">
          ...
          <div>
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-black text-white leading-[1.05] tracking-tight mb-6">
              Автомобили<br />
              <span className="text-brand-red">из Кореи <img src="https://flagcdn.com/kr.svg" alt="Корея" className="inline-block w-16 h-11 rounded-sm align-middle ml-1 shadow-sm" /></span>
            </h1>
