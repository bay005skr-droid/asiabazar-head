...
const MAX = <img src="https://rv-ryazan.ru/wp-content/uploads/2025/12/bc2syA5jnc3Jv3Io5b2mbdWJxyv8-OofOLt2xErdzY2kfyH3vmGauFED8DrlIdh-AUSIpzgdQYfOch-_vb_1RUDf.jpg" alt="MAX" className="w-full h-full object-cover block" />
...
const messengers = [
  ...
  { href: 'https://max.ru/asiabazar25',  label: 'MAX',       bg: 'overflow-hidden', icon: MAX },
]
