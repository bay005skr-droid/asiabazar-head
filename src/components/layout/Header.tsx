  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <Link href="/" className="flex items-center gap-2 group">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-white font-bold text-xl tracking-tight group-hover:text-brand-red transition-colors">
                  АзияБазар
                </span>
              </div>
            </Link>
              ...
              <div className="flex items-center gap-1.5">
                {messengerLinks.map((m) => (
                  <a
                    ...
                    title={m.label}
                    className="w-8 h-8 rounded-full bg-white/5 hover:bg-white/15 flex items-center justify-center text-white/60 hover:text-white transition-all duration-200"
                  >
                    {m.icon}
                  </a>
                ))}
      ...
      >
        ...
        <div
          className={cn(
            'absolute top-0 right-0 h-full w-72 bg-brand-dark-2 border-l border-white/10 shadow-2xl transition-transform duration-300',
              ...
              <div className="flex items-center gap-3">
                {messengerLinks.map((m) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5 hover:bg-white/10 text-white/70 hover:text-white text-sm font-medium transition-all"
                  >
                    {m.icon}
                    <span>{m.label}</span>
                  </a>
